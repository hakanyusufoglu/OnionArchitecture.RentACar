...
namespace WebApi.Controllers
{
    ...
    public class BrandsController : BaseController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetList([FromQuery] PageRequest pageRequest) //Routtan oku
        {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetById([FromRoute] Guid id) //Routtan oku
        {
